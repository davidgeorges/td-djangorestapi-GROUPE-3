...
import { getProjets, deleteProjet, exportProjetsToCsv } from '../service/api';
...
const ResearchProjectList = () => {
  ...
  return (
    <div>
      <ExportCSVButton csvFileName={'projects.csv'} functionToExportCsv={exportProjetsToCsv} handleSnackbarError={handleSnackbarError}/>
      <List>
